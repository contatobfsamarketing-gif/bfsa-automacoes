...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-gold rounded-full flex items-center justify-center shadow-lg shadow-gold/30 hover:scale-110 transition-all duration-300 whatsapp-pulse opacity-100 translate-y-0"
